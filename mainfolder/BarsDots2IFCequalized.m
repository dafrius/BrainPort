...
load twoifcmatrixequalized.mat twoifcmatrix1
...
while (strCase1R>2 && strCase2R>2)==0
    ...
    if trialMat(1,trialNo)==0 %staircase1
        ...
        if trialMat(2,trialNo)==0
            ...
            commm2=['echo iod.file: C:\\i686-w64-mingw32\\tmp\\thresholdtests\\spreadintensity\\' filename1 '>client.in'];
            system(commm2, '-echo');
            ...
            commm2=['echo iod.file: C:\\i686-w64-mingw32\\tmp\\thresholdtests\\spreadintensity\\' filename2 '>client.in'];
            system(commm2, '-echo');
