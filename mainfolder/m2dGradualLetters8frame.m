...
load gradlettersinfo3.mat gradlettersinfo8frame

commm1='cd C:\i686-w64-mingw32\tmp';
system(commm1,'-echo');

randomizer=randperm(52);
names=gradlettersinfo8frame.names;
duration=gradlettersinfo8frame.duration;
condition=gradlettersinfo8frame.condition;
...
Fs=50000;
%------------------------------Trial Loop---------------------------------%
for i=str2num(answr3{1}):length(gradlettersinfo8frame.letter) %%%%changethis
 while anscntr==i
    iodcrash=0;
    rts=[];
