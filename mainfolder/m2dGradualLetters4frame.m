...
load gradlettersinfo2.mat gradlettersinfo4frame

commm1='cd C:\i686-w64-mingw32\tmp';
system(commm1,'-echo');

randomizer=randperm(52);
names=gradlettersinfo4frame.names;
duration=gradlettersinfo4frame.duration;
condition=gradlettersinfo4frame.condition;
...
Fs=50000;
%------------------------------Trial Loop---------------------------------%
for i=str2num(answr3{1}):length(gradlettersinfo4frame.letter) %%%%changethis
 while anscntr==i
    iodcrash=0;
    rts=[];
