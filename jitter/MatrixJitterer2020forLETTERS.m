...
nonjitterimage=Qmatrix;
jitterhori=fopen([pwd filesep 'Qjitter.txt'],'w');
...
for i=1:15
    ...
    %%%MidCent
        ...
        imgJhori(2:19,2:19)=nonjitterimage(2:19,2:19);
    ...
    %%%MidRight
        if immat(j)==6
    imgJhori=zeros(20,20);                 
    imgJhori(2:19,3:20)=nonjitterimage(2:19,2:19);
    fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    ...
    %MidLeft
        if immat(j)==4
    imgJhori=zeros(20,20);                 
    imgJhori(2:19,1:18)=nonjitterimage(2:19,2:19);
    fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    ...
    %BotCent
        if immat(j)==8
    imgJhori=zeros(20,20);                 
    imgJhori(3:20,2:19)=nonjitterimage(2:19,2:19);
    fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    ...
    %BotLeft
        if immat(j)==7
    imgJhori=zeros(20,20);                 
    imgJhori(3:20,1:18)=nonjitterimage(2:19,2:19);
    fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    ...
    %BotRight
        if immat(j)==9
    imgJhori=zeros(20,20);                 
    imgJhori(3:20,3:20)=nonjitterimage(2:19,2:19);
    fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    ...
    %TopCent
        if immat(j)==2
    imgJhori=zeros(20,20);                 
    imgJhori(1:18,2:19)=nonjitterimage(2:19,2:19);
    fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    ...
    %TopRight
        if immat(j)==3
    imgJhori=zeros(20,20);                 
    imgJhori(1:18,3:20)=nonjitterimage(2:19,2:19);
    fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    ...
    %TopLeft
        if immat(j)==1
    imgJhori=zeros(20,20);                 
    imgJhori(1:18,1:18)=nonjitterimage(2:19,2:19);
%     fwrite(jitterhori, transpose(imgJhori));
    imshow(imgJhori);
        end
    end
