...
quickfixKey=KbName('q');
    ...
    locationsinfo=[repmat(1:16,1,1); repmat(128,1,16); zeros(1,16)];
    locs=0;
    resultmat=zeros(2,16);
while locs<16
    ...
    elseif locationsinfo(3,randomloc)==0
        locationsinfo(2,randomloc)=locationsinfo(2,randomloc)+20;    
    end
    ...
    commm2=['echo iod.file: C:\\i686-w64-mingw32\\tmp\\DRStimuli16\' filename '>client.in'];
    system(commm2, '-echo');
    WaitSecs(5);
    system(commm2, '-echo');
